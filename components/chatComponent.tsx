...
<div className="chat-box flex flex-col h-screen overflow-y-auto bg-gray-100 dark:bg-gray-800 px-4 py-8 rounded-md shadow-md">
    ...
    <h3 className="assistant-name text-lg font-semibold text-blue-700 flex justify-center ">
      ...
      <form className="mt-8 flex items-center justify-between w-full" onSubmit={handleSubmit}>
        <textarea
          className="chat-input flex-grow bg-gray-100 dark:bg-gray-800 border  rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 border:ring-blue-500 focus:ring-opacity-50 resize-none"
          placeholder="Planning your next trip? Let's chat..."
          value={input}
